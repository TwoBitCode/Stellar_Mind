...
- **דמויות חייזרים**:מעניקות למשחק מימד עלילתי וקוסמי. לדוגמה:במשחק של **פענוח אותות חייזרים**, חייזר מופיע, מסביר על אותות וסימנים שהשחקן צריך לזכור ולתרגם, ומחבר את המשימה לסיפור המשחק.
- במשימות כמו **מיון אסטרואידים** או **סידור מבחנות**, החייזרים מספקים אסטרטגיות ועידוד שמסייעים לשחקן להתמודד עם המשימות.


- **עצמים הקשורים לעלילה**:כל העצמים במשחק, כמו אסטרואידים, מבחנות, ואותות, הם חלק מהעולם הסיפורי:
